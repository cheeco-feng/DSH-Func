 ...
 * 变化，因此以上所有操作都无需重启。
 */
export const name = "dsh-tool-skill-mcp-panel";
    ...
    invocations: [
        {
            ...
            parameters: [
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#sessionId", schema: sessionIdSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SkillListResult", schema: listResultSchema }
        },
        {
            ...
            invocation: { kind: "direct" },
            parameters: [],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#WorkspacesResult", schema: workspacesResultSchema }
        },
        {
            ...
            invocation: { kind: "direct" },
            parameters: [],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#GroupsResult", schema: groupsResultSchema }
        },
        {
            ...
            invocation: { kind: "direct" },
            parameters: [],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#CheckUpdateResult", schema: checkUpdateResultSchema }
        },
        {
            ...
            invocation: { kind: "direct" },
            parameters: [
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SaveGroupPayload", schema: saveGroupPayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#GroupsResult", schema: groupsResultSchema }
        },
        {
            ...
            invocation: { kind: "direct" },
            parameters: [
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#DeleteGroupPayload", schema: deleteGroupPayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#GroupsResult", schema: groupsResultSchema }
        },
        {
            ...
            invocation: { kind: "direct" },
            parameters: [
                { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SkillName", schema: z.string() } },
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#sessionId", schema: sessionIdSchema } },
                { name: "scope", wire: "scope", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SkillScope", schema: z.union([z.string(), z.null()]) } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SkillContent", schema: skillContentSchema }
        },
        {
            ...
            parameters: [
                { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SkillName", schema: z.string() } },
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#sessionId", schema: sessionIdSchema } },
                { name: "enabled", wire: "enabled", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#EnabledFlag", schema: z.boolean() } },
                { name: "scope", wire: "scope", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SkillScope", schema: z.union([z.string(), z.null()]) } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SetEnabledResult", schema: setEnabledResultSchema }
        },
        {
            ...
            parameters: [
                { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#SkillName", schema: z.string() } },
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#sessionId", schema: sessionIdSchema } },
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#MigratePayload", schema: migratePayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#MigrateResult", schema: migrateResultSchema }
        },
        {
            ...
            parameters: [
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#sessionId", schema: sessionIdSchema } },
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#BatchMigratePayload", schema: batchMigratePayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#BatchMigrateResult", schema: batchMigrateResultSchema }
        },
        {
            ...
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#DeleteSkillResult", schema: deleteSkillResultSchema }
        },
        {
            ...
            parameters: [
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#sessionId", schema: sessionIdSchema } },
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#AddPayload", schema: addPayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dsh-tool-skill-mcp-panel#AddResult", schema: addResultSchema }
        }
    ],
...
export function apply(ctx) {
    ...
    ctx.effect(() => ctx.typert.register(PANEL_MANIFEST), "dsh-tool-skill-mcp-panel: typert manifest");

/**
 * @cheeco/dsh-client-ui-mobile, node half. Mostly a client UI plugin: apply() exists so the
...
export function apply(ctx) {
    ...
    ctx.effect(() => installResponseCompression(), '@cheeco/dsh-client-ui-mobile: response compression');
}

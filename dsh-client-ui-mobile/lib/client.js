window.__ModuleLoader__.load({ id: "@cheeco/dsh-client-ui-mobile", factory: (require) => {
var __modules = {};
...
function apply(ctx) {
    ...
    ctx.effect(() => {
        ...
        tag.dataset.plugin = '@cheeco/dsh-client-ui-mobile';
        tag.dataset.pluginCss = '@cheeco/dsh-client-ui-mobile/mobile.css';

/** 功能推荐列表（独立于 dsh-web-ui-cheeco-style，随 dsh-client-ui-plugin-push 发布）。
...
export const CHEECO_FEATURES = [
	{ id: "style", name: "界面/声音设置", pkg: "@cheeco/dsh-web-ui-cheeco-style", install: "https://github.com/cheeco-feng/DSH-Func/releases/download/v0.8.17/cheeco-dsh-web-ui-cheeco-style-0.8.17.tgz", folder: "dsh-web-ui-cheeco-style", url: "https://github.com/cheeco-feng/DSH-Func" },
	...
	{ id: "systeminfo", name: "系统信息", pkg: "@cheeco/dsh-client-ui-system-info", install: "https://github.com/cheeco-feng/DSH-Func/releases/download/v0.2.4/cheeco-dsh-client-ui-system-info-0.2.4.tgz", folder: "dsh-client-ui-system-info", url: "https://github.com/cheeco-feng/DSH-Func" },
	{ id: "usercenter", name: "用户中心", pkg: "@cheeco/dsh-web-ui-web_user_center", install: "https://github.com/cheeco-feng/DSH-Func/releases/download/v0.1.0/cheeco-dsh-web-ui-web_user_center-0.1.0.tgz", folder: "dsh-web-ui-web_user_center", url: "https://github.com/cheeco-feng/DSH-Func" },
	{ id: "model-settings", name: "模型设置", pkg: "@cheeco/dsh-llm-model-settings", install: "https://github.com/cheeco-feng/DSH-Func/releases/download/v0.1.1/cheeco-dsh-llm-model-settings-0.1.1.tgz", folder: "dsh-llm-model-settings", url: "https://github.com/cheeco-feng/DSH-Func" }
];

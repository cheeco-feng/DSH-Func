...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** 内页：tab 结构，「功能表」「系统信息」「面版管理」三个 tab。
     *  「系统信息」页内容由 dsh-client-ui-system-info 经子 slot `dsh-system-package.system-info`
    ...
    function apply(ctx) {
      ...
      // 「系统信息」tab 用到的基础子 slot，必须在此声明，settings.section 才会把 renderSlot

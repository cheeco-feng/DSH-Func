// ../Program Files/DeepSeek Harness Original/engine/node_modules/@deepseek-ai/cosmokit/lib/index.js
...
// ../Program Files/DeepSeek Harness Original/engine/node_modules/@deepseek-ai/schemastery/lib/index.mjs
...
// _build/src/config.ts
var DEFAULT_CONFIG = {
  enabled: true,
  defaultMode: "title"
};
var SWITCH_SEARCH_SETTINGS_NAMESPACE = "switch-search";

// _build/src/index.ts
var name = "dsh-client-ui-session-search";
var inject = ["webServer", "webRuntime"];
var Config = Schema.object({
  enabled: Schema.boolean().default(true),
  defaultMode: Schema.union(["title", "content"]).default("title")
});
...
var ALL_CONTENT_TYPES = ["user/message", "assistant/message", "tool/call", "tool/result"];
...
async function listSessions(ctx) {
  ...
  if (sessionQuery === void 0) return { ok: false, error: "sessionQuery \u670D\u52A1\u4E0D\u53EF\u7528" };
  try {
...
function apply(ctx) {
  ctx.effect(() => ctx.webServer.register({
    ...
    handler: async (req, res) => {
      ...
      const method = pathname.startsWith("/switch-search/api/") ? pathname.slice("/switch-search/api/".length) : void 0;
